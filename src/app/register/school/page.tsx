      ...
      <Card className="shadow-lg mt-16">
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <Input value={formData.schoolName} onChange={(e) => handleChange("schoolName", e.target.value)} placeholder="Enter your school name" className="mt-2" />
          </div>
